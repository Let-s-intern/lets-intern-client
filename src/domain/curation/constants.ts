...
export const CHALLENGE_COMPARISON: ChallengeComparisonRow[] = [
  {
    ...
    feedback: '일부 선발 피드백',
    deliverable: 'STAR 기반 경험정리본',
    features: ['마인드맵 · STAR 기법'],
  },
  {
    programId: 'resume',
    label: '이력서 1주 완성',
    target: '빠르게 이력서를 완성해야 하는 분',
    duration: '1주',
    pricing: '베이직 10,000원 / 스탠다드 29,900원',
    feedback: '스탠다드 1회',
    deliverable: '멘토 피드백 반영 이력서 + 합격자 10선',
    features: ['1주 집중', '합격 이력서 예시'],
  },
  {
    programId: 'coverLetter',
    label: '자기소개서',
    target: '자소서를 처음 만들거나 고도화하고 싶은 분',
    duration: '2주',
    pricing: '베이직 38,500원 / 스탠다드 64,000원 / 프리미엄 89,000원',
    feedback: '스탠다드 1회 · 프리미엄 2회',
    deliverable: '마스터 자기소개서 + 합격자 예시',
    features: ['K-STAR-K · 3WHY'],
  },
  {
    programId: 'portfolio',
    label: '포트폴리오',
    target: '직무 맞춤 포트폴리오가 필요한 분',
    duration: '2주',
    pricing: '베이직 48,500원 / 스탠다드 78,000원 / 프리미엄 98,500원',
    feedback: '스탠다드 1회 · 프리미엄 2회',
    deliverable: '마스터 포트폴리오 + 합격자 예시',
    features: ['구조화 템플릿'],
  },
  {
    programId: 'enterpriseCover',
    label: '대기업 자소서',
    target: '대기업 맞춤 자소서와 분석 자료가 필요한 분',
    duration: '3주',
    pricing: '베이직 113,500원 / 스탠다드 164,000원 / 프리미엄 214,000원 (환급금 없음)',
    feedback: '스탠다드 2회 · 프리미엄 4회',
    deliverable: '대기업 맞춤 자소서 + 분석 특강 자료',
    features: ['현직자 특강 4회', '기업별 맞춤 분석'],
  },
  {
    programId: 'marketingAllInOne',
    label: '마케팅 올인원',
    target: '마케팅 서류를 한 번에 끝내고 싶은 분',
    duration: '4주',
    pricing: '베이직 99,000원 / 스탠다드 149,000원 / 프리미엄 179,000원 (환급금 없음)',
    feedback: '스탠다드 1회 · 프리미엄 2회',
    deliverable: '경험정리 + 자소서 + 포트폴리오 완성',
    features: ['실무 역량 Class 4회', '현직자 세미나 4회'],
  },
  {
    programId: 'hrAllInOne',
    label: 'HR 올인원',
    target: 'HR 서류를 한 번에 끝내고 싶은 분',
    duration: '3주',
    pricing: '베이직 89,000원 / 스탠다드 123,000원 / 프리미엄 156,000원 (환급금 없음)',
    feedback: '스탠다드 1회 · 프리미엄 2회',
    deliverable: '경험정리 + 자소서 + 포트폴리오 완성',
    features: ['HR 현직자 세미나 4회', '직무 학습 자료'],
  },
];
