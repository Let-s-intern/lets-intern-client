      ...
      {PERSONAS.map((persona) => {
        ...
        return (
          <motion.div
            ...
            className={`group relative flex cursor-pointer flex-col gap-y-2.5 overflow-hidden rounded-md border-2 bg-gradient-to-br p-5 text-left transition-all duration-300 ${
              isActive
