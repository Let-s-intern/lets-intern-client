  ...
  return (
    <section className="flex w-full flex-col items-center justify-center bg-[#0f0d2e] py-20 md:py-28">
      <div className="mx-auto max-w-[1200px] px-6">
        ...
        <div className="mt-10 grid grid-cols-2 gap-3 md:flex md:flex-wrap md:justify-center md:gap-5 [&>*:last-child:nth-child(odd)]:col-span-2 [&>*:last-child:nth-child(odd)]:mx-auto [&>*:last-child:nth-child(odd)]:w-[calc(50%-6px)]">
