...
type RemindersChallengeTableKey =
  | 'type'
  | 'programTitle'
  | 'name'
  | 'email'
...
const RemindersChallenge = () => {
  ...
  const columnMetaData: TableTemplateProps<RemindersChallengeTableKey>['columnMetaData'] =
    {
      type: {
        headLabel: '구분',
        cellWidth: 'w-2/12',
  ...
  return (
    <TableTemplate<RemindersChallengeTableKey>
      title="사전알림신청 - 챌린지"
      headerButton={{
        label: '명단 다운로드',
        href: '#',
...
export default RemindersChallenge;
