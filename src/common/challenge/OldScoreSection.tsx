...
import ScoreTooltipQuestion from './ScoreTooltipQuestion';
import CertificatePaper from './dashboard/CertificatePaper';
...
export default OldScoreSection;
