  ...
  const [missionList, setMissionList] = useState<IMissionTemplate[]>([
    {
      ...
      title: '현직자 인터뷰 정리',
      contents:
        '1️⃣ 콘텐츠 마케팅 직무의 채용공고 3개 이상 정리 - Step 3,4 참고 1️⃣ 콘텐츠 마케팅 직무의 채용공고 3개 이상 정리 - Step 3,4 참고',
      guide:
        '교육 콘텐츠를 따라 직무 인터뷰를 정독하며 나만의 방식으로 정리해보세요! 교육 콘텐츠를 따라 직무 인터뷰를 정독하며 나만의 방식으로 정리해보세요!',
    ...
    },
    {
      ...
      title: '채용공고 정리 및 분석',
      contents:
        '오늘 미션을 인증하면 2,000원 상당의 취업플랫폼 정리본을 드립니다 ⛳️ 오늘 미션을 인증하면 2,000원 상당의 취업플랫폼 정리본을 드립니다 ⛳️',
      guide:
    ...
    <>
      ...
      <TableBodyBox>
        {missionList.map((mission: IMissionTemplate) => (
          <NTableBodyRow key={mission.id} mission={mission} />
        ))}
      </TableBodyBox>
    </>
  );
