    ...
    <div className={clsx('flex flex-col gap-3', className)}>
      ...
      <section className="flex flex-col gap-5 rounded-xs border border-neutral-80 px-4 py-4">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-start gap-2">
              <span className="text-xsmall16 font-medium text-neutral-0">
                1. 대시보드 사용법 및 미션 인증 방식꼭 확인! <br />
                2.마케팅 관심 직무 1개 이상 선정하기
                <br /> 3. 각각 인터뷰 3개 이상 정리하기 <br />
                4. 각각 채용공고 5개 이상 정리 <br />
        ...
        <section className="flex flex-col gap-3">
          ...
          <p className="text-xsmall16 font-medium text-neutral-10">
        ...
        <section className="flex flex-col gap-4 rounded-xxs bg-neutral-95 p-3 pb-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <MissionFileLink
              title="필수 콘텐츠"
              fileName={`경험정리_${todayTh}회차`}
              disabled={false}
            />
            <MissionFileLink
              title="추가 콘텐츠"
              fileName="경험정리_STAR 서류화"
              disabled={false}
            />
          </div>
        </section>
