  ...
  return (
    <>
      ...
      <div className="mt-8">
        ...
        <p className="mt-5 text-xsmall16 whitespace-pre-line font-medium text-black">
          {missionDetail.guide}
        </p>
      </div>
      <div className="mt-8 flex gap-4">
        <Link
          ...
          className="rounded-sm flex-1 border border-primary-20 bg-white p-3 text-center text-xsmall16 font-medium"
          target="_blank"
