  ...
  return (
    <div className={clsx('flex flex-col gap-3', className)}>
      ...
      <section className="flex flex-col gap-5 rounded-xs border border-neutral-80 px-4 py-4">
        ...
        <section className="flex flex-col gap-4">
          <h3 className="text-xsmall16 font-semibold text-neutral-0">
            2️⃣ 블로그 후기 가이드라인을 안내드려요
          </h3>
          <div className="flex flex-col gap-2 rounded-xxs bg-primary-5 p-3">
            <div className="flex items-start gap-2">
              <p className="text-xsmall16 font-medium leading-8 text-neutral-0">
                1.<b>이미지</b> <br />- 활동 인증 이미지 3장 이상 필수 첨부{' '}
                <br />
                2. <b>필수 키워드</b> <br />- 블로그 본문 내 필수 키워드 포함:
                렛츠커리어, 취준, 프로그램명 <br />
                3. <b>작성기준</b>: 위의 키워드 중 제목, 본문, #태그에 아래와
                같이 키워드를 기재해 주세요. <br />
                - 제목: 필수 키워드 3개를 포함하여 자유롭게 작성 <br />- 본문:
                ‘렛츠커리어’, ‘취준’ 키워드를 본문에 3회 이상 언급 <br />
                - #해시태그: 제시된 키워드 모두 기재해 주세요.(*키워드가
                지켜지지 않으면 수정요청이 있을 수 있어요.) <br />
                4. <b>공개설정</b> <br />- 블로그 글은 전체 공개로 설정해주세요.
              </p>
            </div>
          </div>
        </section>
