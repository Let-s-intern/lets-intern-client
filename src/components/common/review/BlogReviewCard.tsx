...
const BlogReviewCard = ({ blogReview }: Props) => {
  return (
    <div className="p-4 border rounded-sm gap-4 md:gap-0 flex md:justify-between flex-col md:flex-row border-neutral-80">
      <div>
      ...
      <div className="w-40 h-[5.625rem] md:w-60 md:h-[8.5rem] bg-neutral-85 rounded-sm">
        <Image
          src={''}
