...
const ReportNavigation = ({
  ...
  return (
    <nav
      className={twMerge(
        'report_navigation sticky top-[3.65rem] z-20 flex w-full transform justify-center gap-x-1 px-6 transition-all duration-300 md:top-[4.275rem] md:gap-x-[100px] lg:top-[6.88rem]',
