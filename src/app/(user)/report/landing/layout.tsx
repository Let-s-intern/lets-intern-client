...
const ReportNavigationTabs = ({
  ...
  return (
    <nav
      className={`fixed top-[45px] z-20 flex w-screen justify-center bg-white ${scrollDirection === 'DOWN' ? '-translate-y-[302%]' : 'translate-y-0'} transition-transform duration-300 md:top-[140px] lg:top-[7.25rem]`}
    >
