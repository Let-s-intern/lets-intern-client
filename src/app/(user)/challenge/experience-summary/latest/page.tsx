...
/**
 * 경험정리 챌린지의 latest 리다이렉트를 처리하는 컴포넌트
 *
 * 리다이렉트 우선순위:
 * 1. 모집중인(active) 경험정리 챌린지 중 B2C 챌린지가 있을 경우 해당 챌린지로 이동
 * 2. 없을 경우 가장 최근 개설된 경험정리 챌린지 중 B2C 챌린지로 이동
 */
export default function ExperienceSummaryLatest() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-gray-600">경험정리 챌린지로 이동 중...</p>
        {(activeLoading ||
          listLoading ||
          isFilteringActive ||
          isFilteringList) && (
