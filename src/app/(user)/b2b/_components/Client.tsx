          ...
          <SectionHeader
            ...
            desc={
              <>
                ...
                <Break /> 교육 파트너와 함께한 성과를 통해 렛츠커리어의 검증된 취업 교육을 확인하세요.
              </>
            }
          />
          <motion.div
      ...
      <section className="w-full bg-[#F7F9FF]">
        <div className="mw-1180 py-24 md:py-32">
          <SectionHeader
            ...
            desc={<>수많은 취업준비생들과 교육 파트너가 렛츠커리어와 함께하는 이유입니다.</>}
          />
          <motion.div
            className="mt-10"
      ...
      <section className="w-full">
        <div className="mx-auto py-24 text-center md:py-32">
          <SectionHeader
            ...
            desc={
              <>
                렛츠커리어는 마케팅, PM, 개발 등 다양한 직무의 현직자 멘토풀을 보유하고 있습니다. <Break />
                현직자 멘토풀을 통해 교육생들에게 최신 합격 트렌드를 기반으로 한 <Break />
