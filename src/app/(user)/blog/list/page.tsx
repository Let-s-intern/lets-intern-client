...
export default function Page() {
  return (
    <div className="flex flex-col items-center">
      {/* 블로그 배너 */}
      <section className="mb-8 flex h-[154px] w-full items-center bg-blog-banner-sm bg-cover bg-no-repeat px-5 md:mb-11 md:h-[168px] md:bg-blog-banner-md md:px-0 lg:bg-blog-banner-lg">
      ...
      {/* 블로그 콘텐츠 */}
      <section className="mx-auto mb-12 w-full max-w-[1100px] px-5 md:mb-20 md:px-0">
        <BlogListContent />
      </section>
    </div>
  );
