...
import FindPassword from './pages/common/FindPassword';
import Privacy from './pages/common/Privacy';
import Review from './pages/common/Review';
import Layout from './pages/Layout';
import AdminLayout from './pages/AdminLayout';
import ProgramCreate from './pages/admin/program/ProgramCreate';
import ReviewDetail from './pages/common/ReviewDetail';
...
import ReviewCreate from './pages/common/ReviewCreate';
