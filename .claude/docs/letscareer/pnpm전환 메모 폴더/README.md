...
| [04-vercel-deployment.md](./04-vercel-deployment.md) | 3개 Vercel 프로젝트 분리 설정, Skip Unaffected Projects, 환경변수, SPA rewrite |
...
| [07-build-filter.md](./07-build-filter.md) | Skip Unaffected + Custom IBS 결합으로 `.md`/dev 폴더 변경 시 빌드 스킵 |
...
| Vercel 빌드 왜 다 도는지 (또는 안 도는지)? | [07](./07-build-filter.md) |
