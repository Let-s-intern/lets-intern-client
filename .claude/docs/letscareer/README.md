...
└── pnpm전환 메모 폴더/                    # pnpm 전환·운영 메모
    ...
    └── 07-build-filter.md               # Skip Unaffected + Custom IBS 결합
```
...
| 디자인 토큰·스타일링 컨벤션 | [`design-system.md`](./design-system.md) |
| 헤드리스 컴포넌트 만들기·공용화 판단 | [`headless-components.md`](./headless-components.md) |
...
| 빌드 스킵·Ignored Build Step | [`pnpm전환 메모 폴더/07-build-filter.md`](./pnpm전환%20메모%20폴더/07-build-filter.md) |
