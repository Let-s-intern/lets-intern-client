...
- [x] 3.0 FeedbackIntroSection + MentorListSection 구현
    - [x] 3.1 FeedbackOptionCard 컴포넌트
        ...
        - [ ] 3.1.T1 테스트 코드 작성
        - [ ] 3.1.T2 테스트 실행 및 검증
    - [x] 3.2 FeedbackDetailModal 컴포넌트 (FeedbackOptionCard 내 확장형 패널로 통합 구현)
        - "피드백 자세히 보기" 클릭 시 서면 피드백 이미지 표시
        - 모달 또는 확장형 패널
        - 닫기 버튼
        - [ ] 3.2.T1 테스트 코드 작성
        - [ ] 3.2.T2 테스트 실행 및 검증
    - [x] 3.3 FeedbackIntroSection
        - 좌측: 피드백 리포트 이미지 + 카피
