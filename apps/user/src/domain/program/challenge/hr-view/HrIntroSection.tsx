...
const IntroBubble = ({
  ...
  const base =
    'relative w-full min-w-0 max-w-full rounded-xl bg-[#FEEFE6] p-5 text-center text-xsmall14 md:min-w-0 md:max-w-full md:px-[60px] md:py-[30px] md:text-left md:text-small20 md:w-fit';
  const tailBase =
...
function HrIntroSection() {
  return (
    <section className="flex w-full scroll-mt-[56px] flex-col items-center overflow-x-hidden bg-[#FFFAF7] px-5 pb-10 pt-[60px] md:scroll-mt-[60px] md:pb-10 md:pt-[93px]">
      {/* Header */}
      <div>
        <MainTitle>
          <span>HR/인사 직무,</span>
      ...
      <div className="mt-5 flex w-full min-w-0 flex-col items-center gap-7 md:mt-[52px] md:gap-[18px]">
        <div className="min-w[870px] flex w-full min-w-0 max-w-[990px] flex-col items-stretch gap-7 md:gap-1">
          ...
          <div className="w-full min-w-0 md:-mt-[90px]">
          ...
          <div className="w-full min-w-0 md:mx-auto md:mb-8 md:mt-5 md:w-fit">
            <IntroBubble align="left">
              자기소개서랑 포트폴리오는
