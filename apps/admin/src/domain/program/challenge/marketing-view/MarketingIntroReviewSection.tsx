    ...
    <section className="relative flex flex-col items-center bg-[linear-gradient(0deg,#F0F4FF_0%,#E3E5FB_105.65%)] px-5 pb-10 pt-[114px] md:pb-20 md:pt-[114px]">
      ...
      <div className="mt-8 flex flex-col items-center gap-1 md:gap-3">
        <div className="flex w-[242px] flex-col items-center gap-3 md:w-[622px]">
          <IntroBubble className="bg-primary text-primary-5 py-[18px] font-bold md:mr-auto md:font-medium">
            ...
            시작했어요!
            <p className="text-xxsmall12 text-primary-20 md:text-xsmall16 mt-3 text-center font-bold md:font-medium">
          ...
          <IntroBubble className="bg-[#ffffff] py-[18px] font-bold md:ml-auto md:font-medium">
            ...
            <p className="text-xxsmall12 md:text-xsmall16 mt-3 text-center font-bold md:font-medium">
              <strong className="font-bold">비전공자 </strong>마케터 직무 희망
              김렛커
            </p>
          </IntroBubble>
          <div className="w-full">
            <IntroBubble className="bg-primary text-primary-5 py-[18px] font-bold md:font-medium">
            ...
            <div
              className="bubble-tail border-t-primary mx-auto h-0 w-0 border-l-[9px] border-r-[9px] border-t-[14px] border-l-transparent border-r-transparent"
              aria-hidden="true"
            />
          </div>
        </div>
        ...
        <button
          type="button"
          className="z-1 text-xsmall16 md:text-medium22 relative mt-[60px] flex w-[320px] items-center justify-center gap-2 rounded-sm bg-[#0C1737] px-0 py-4 text-center font-semibold text-white md:w-auto md:px-5"
        >
