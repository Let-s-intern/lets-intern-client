  ...
  return (
    <section className="flex flex-col gap-20 px-5 py-20 sm:px-10 sm:py-[6.25rem] lg:gap-[6.25rem] xl:py-[8.75rem]">
      ...
      <div className="relative flex w-full flex-col items-center">
        {/* Backward */}
        <div className="bg-primary-20 absolute -top-8 h-32 w-[15.5rem] -translate-x-8 -rotate-12 rounded-sm sm:-translate-x-12"></div>
        {/* Forward */}
        <div
          style={cardStyle}
          className="border-neutral-80 bg-static-100/80 shadow-06 z-10 flex w-[17.5rem] flex-col gap-5 rounded-sm border p-5"
        >
