...
interface Props {
  ...
  /** 경로의 role 세그먼트 — 로그인 전 문구·리다이렉트 표시용(권한 판정에 쓰지 않는다). */
 ...
 */
const LoginGate = ({ applicationId, role }: Props) => {
  ...
  /*
    ...
    경로가 어긋나면 카카오·네이버로 로그인한 뒤 404 로 떨어진다.
  */
      ...
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <div className="flex flex-col gap-1">
          <h1 className="text-small18 text-neutral-0 font-bold">
            {role === 'MENTOR' ? '멘티' : '멘토'}와 1:1 LIVE 멘토링
          </h1>
