...
const MODAL_CONTENTS: Record<string, React.ReactNode> = {
  guidebook: (
    <>
    ...
    <>
      ...
      <div className="modal-body">
        ...
        <div className="m-gallery">
          <figure>
            {/* TODO(MVP): 실제 이미지로 교체 */}
            <img src="" alt="경험정리 챌린지" loading="lazy" />
            <figcaption>경험정리 챌린지</figcaption>
          </figure>
          <figure>
            {/* TODO(MVP): 실제 이미지로 교체 */}
            <img src="" alt="이력서 챌린지" loading="lazy" />
            <figcaption>이력서 1주 완성</figcaption>
          </figure>
          <figure>
            {/* TODO(MVP): 실제 이미지로 교체 */}
            <img src="" alt="자기소개서 챌린지" loading="lazy" />
            <figcaption>자기소개서 완성</figcaption>
          </figure>
          <figure>
            {/* TODO(MVP): 실제 이미지로 교체 */}
            <img src="" alt="대기업 공채 자소서 챌린지" loading="lazy" />
            <figcaption>대기업 공채 자소서</figcaption>
          </figure>
          <figure>
            {/* TODO(MVP): 실제 이미지로 교체 */}
            <img src="" alt="포트폴리오 챌린지" loading="lazy" />
            <figcaption>포트폴리오 완성</figcaption>
          </figure>
          <figure>
            {/* TODO(MVP): 실제 이미지로 교체 */}
            <img src="" alt="면접 챌린지" loading="lazy" />
            <figcaption>면접 끝장 챌린지</figcaption>
          </figure>
          <figure>
            {/* TODO(MVP): 실제 이미지로 교체 */}
            <img src="" alt="마케팅 직무 챌린지" loading="lazy" />
            <figcaption>마케팅 올인원</figcaption>
          </figure>
          <figure>
            {/* TODO(MVP): 실제 이미지로 교체 */}
            <img src="" alt="HR 직무 챌린지" loading="lazy" />
            <figcaption>HR/인사 직무</figcaption>
          </figure>
          <figure>
            {/* TODO(MVP): 실제 이미지로 교체 */}
            <img src="" alt="PM 서비스기획 챌린지" loading="lazy" />
            <figcaption>PM/서비스기획</figcaption>
          </figure>
        </div>
        ...
        <p className="m-note">
          할인율은 플랜 등급에 따라 달라져요. (베이직 기타 10% · 스탠다드 대기업
          25%/기타 15% · 프리미엄 대기업 30%/기타 20%)
        </p>
      </div>
      <div className="modal-foot">
        <button
  ...
  partner: (
    <>
      ...
      <div className="modal-body">
        ...
        <p className="m-note">
          제휴 혜택은 순차적으로 오픈될 예정이에요. 멤버십 가입자에게 가장 먼저
          안내드릴게요.
        </p>
      </div>
      <div className="modal-foot">
