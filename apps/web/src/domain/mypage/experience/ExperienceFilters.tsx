...
import { MultiFilterDropdown } from '@/domain/challenge/my-challenge/mission/submit/ui/mission-submit-list-form/components/ExperienceSelectModal/components/MultiFilterDropdown';
...
const ExperienceFilters = ({
  ...
  return (
    <div className="scrollbar-hide flex gap-2 overflow-x-auto md:overflow-visible">
      <MultiFilterDropdown
        labelPrefix="경험 분류"
