...
import NoticeGuideLink from '@/domain/challenge/dashboard/ui/NoticeGuideLink';
...
const GuideSection = ({ guides }: GuideSection) => {
  ...
  return (
    <section className="rounded-xs relative w-[calc((100%-12px)/2)] flex-1 flex-col border border-[#E4E4E7] p-4 md:h-40">
      <div className="flex flex-col gap-3">
        <div className="flex items-center justify-between">
          <h2 className="text-neutral-10 font-semibold">챌린지 가이드</h2>
