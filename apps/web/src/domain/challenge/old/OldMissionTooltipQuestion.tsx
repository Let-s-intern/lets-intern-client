    ...
    >
      ...
      {isTooltipOpen && (
        <div className="absolute -right-4 -top-3 z-30 translate-x-full drop-shadow-xl">
          <div
            className="bg-static-100 absolute left-[1.5px] top-1.5 h-6 w-3 -translate-x-full"
          ...
          <div
            ...
            style={{ clipPath: 'polygon(0% 50%, 100% 100%, 100% 0%)' }}
          />
          <div className="rounded-xs bg-static-100 flex h-[340px] w-[380px] items-center p-4">
            <img
