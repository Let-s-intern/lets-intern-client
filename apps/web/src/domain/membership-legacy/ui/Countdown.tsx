...
export default function Countdown({ deadline }: CountdownProps) {
  ...
  return (
    <>
      <div className="seg">
        <span className="n num tick">{String(t.days).padStart(2, '0')}</span>
        <span className="l">일</span>
      </div>
      <div className="seg">
        <span className="n num tick">{pad(t.hours)}</span>
        <span className="l">시간</span>
      </div>
      <div className="seg">
        <span className="n num tick">{pad(t.minutes)}</span>
        <span className="l">분</span>
      </div>
      <div className="seg">
        <span className="n num tick">{pad(t.seconds)}</span>
