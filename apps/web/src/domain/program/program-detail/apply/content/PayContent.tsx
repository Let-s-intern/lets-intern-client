...
const PayContent = ({
  ...
  return (
    <div className={`flex h-full flex-col gap-3 ${isMobile ? 'px-5' : ''}`}>
      <h2 className="text-small20 pb-6 pt-3 font-bold md:py-0" ref={topRef}>
        결제하기
      </h2>
      ...
      <div
        className={twMerge(
          ...
          isMobile && 'shadow-05 -mb-3 rounded-t-lg py-3',
        )}
      >
        <button
          className="border-primary text-primary-dark flex w-full flex-1 items-center justify-center rounded-md border-2 bg-neutral-100 px-6 py-3 text-lg font-medium"
        ...
        <button
          className="complete_button text-1.125-medium bg-primary flex w-full justify-center rounded-md px-6 py-3 font-medium text-neutral-100"
          onClick={() => {
