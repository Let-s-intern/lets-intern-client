    ...
    >
      ...
      <div className="flex w-full flex-col items-start justify-center gap-y-6">
        ...
        <div className="flex w-full flex-col items-start justify-start">
          <div className="border-neutral-0 flex w-full items-center justify-start gap-3 border-y-[1.5px] px-3 py-5">
            ...
            <div className="flex w-full flex-col">
              <ReportCreditRow
                ...
                content={
                  Math.max(
                    0,
                    nearestTen(reportDiscountedPrice * reportRefundPercent) -
                      couponDiscountPrice,
                  ).toLocaleString() + '원'
                }
              />
                ...
                <div className="flex w-full flex-col">
                  ...
                  <ReportCreditSubRow
                    ...
                    content={`-${(
                      ...
                      nearestTen(feedbackDiscountPrice * feedbackRefundPercent)
                    ).toLocaleString()}원`}
                  />
                </div>
              </div>
