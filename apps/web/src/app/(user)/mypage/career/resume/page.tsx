...
import { UploadedFiles } from '@/domain/challenge/my-challenge/section/mission-submit/MissionSubmitTalentPoolSection';
...
export default function Page() {
  ...
  return (
    <div>
      <label>
        <h1 className="text-small18 mb-1.5 font-medium">나의 서류</h1>
